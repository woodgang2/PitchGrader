...
with tab1:
    ...
    st.session_state.player_name_update = st.selectbox('Name', options=options, index = 0, key='player_name')#, on_change=first_click)# index=default_index, key='player_name')
