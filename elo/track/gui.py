...
if not st.session_state.team_flag:
    ...
    if selected_name != '':
        ...
        if (df.empty) or (selected_name.split(', ')[1] == 'Batter'):
            ...
            stuff_df = stuff_df.drop_duplicates(subset=['Pitcher', 'PitchType'])
            ...
            stuff_df2 = stuff_df2.merge (location_df, on = 'Pitcher')
            stuff_df2 = stuff_df2.drop_duplicates(subset=['Pitcher', 'PitchType'])
    ...
    if team_name != '':
        ...
        if (df.empty):
            ...
            desired_order = ['Pitcher', 'PitcherTeam', 'PitcherThrows', 'PitchCount', 'Command', 'Stuff', 'FF', 'SI', 'FC', 'SL', 'CU', 'FS', 'CH']
            stuff_df = stuff_df.rename(columns=rename_columns)
